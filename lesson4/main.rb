...
def start_program(number)
  create_station if number == 1
  create_train if number == 2
  create_route if number == 3
  add_station_route if number == 4
  delete_station_rout if number == 5
  add_route_train if number == 6
  add_wagon_train if number == 7
  delete_wagon_train if number == 8
  forward_train if number == 9
  back_train if number == 10
  stations_user_all if number == 11
  train_in_station if number ==12
  exit if number == 0
end
